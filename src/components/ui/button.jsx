  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary: "bg-accent text-primary-foreground hover:bg-accent/90",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        tertiary:
          "text-neutral-800 hover:bg-neutral-200 active:bg-neutral-200 disabled:text-neutral-400",
        accent: "bg-accent text-primary-foreground hover:bg-accent/90",
        ghost: "hover:bg-primary hover:text-primary-foreground",
        ghostAccent: "hover:bg-accent hover:text-accent-foreground",
        link: "p-0 text-primary underline-offset-4 hover:underline",
        navlinkGhost: "text-base hover:bg-secondary/20 hover:text-default",
        linkOutlined:
      ...
      size: {
        ...
        xl: "h-12 rounded-md px-4 font-semibold text-base",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
